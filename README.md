...
VegaUbuntuGuidWithAutoTools - How to setup Vega mining in Ubuntu with 90% automation.  Escentially the same as VegaUbuntuGuide but after a few manual downloads, run the scripts to setup. Coming soon...
